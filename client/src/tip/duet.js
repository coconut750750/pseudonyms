...
export const wordScore = "There are 15 green words for both teams to guess. The colors each team sees are different, but some colors overlap. If a word appears green for both teams, only one team needs to reveal it."; 
...
export const mistakeScore = "If the other team guesses incorrectly, a badge of your color appears on the word, indicating to them that the word is white for you. You can still guess it, but it could be any color for them.";
