...
export const mistakeScore = "If you guess incorrectly, a badge of the other team's color appears on the word, indicating that the word is white to them. That word might appear green to you, in which case the other team must guess it.";
export const firstTurn = "Either team can give the first clue.";
export const suddenDeath = "Any player can continue guessing without any more clues. An incorrect guess ends the game.";
